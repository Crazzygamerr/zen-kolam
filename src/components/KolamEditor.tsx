...
export const KolamEditor: React.FC = () => {
	...
	const copyRawSVG = async () => {
		...
		<div className="kolam-editor bg-amber-100 text-amber-900 min-h-screen">
			{/* Header */}
			<header className="p-4 flex text-white" style={{ backgroundColor: '#5ba293' }}>
				<div className="w-full px-4 mx-auto">
					<h1 className="text-lg font-bold tracking-wide">
						Zen Kolam Generator
					</h1>
					<p className="mt-2 hidden lg:block text-md opacity-90">
				...
				<div className="max-w-6xl mx-auto flex justify-center items-center gap-6">
					<div className="flex gap-4">
						...
						>
							...
							<span className="text-sm hidden lg:block">GitHub</span>
						</a>
					</div>
				</div>
			...
			<div className="w-full flex flex-col lg:flex-row" style={{ height: 'calc(100vh - 120px)' }}>
				{/* Display Area - full width on mobile, 3/4 on desktop */}
				<div className="kolam-display-area w-full lg:w-3/4 h-full p-4">
					{currentPattern ? (
						<div
							ref={kolamRef}
							className="kolam-container relative flex justify-center items-center bg-amber-900 border-4 border-white rounded-2xl shadow-lg w-full h-full"
						>
							<KolamDisplay
				...
				<div className="w-full lg:w-1/4 h-full p-4 overflow-y-auto">
					<div className="bg-amber-900 border-4 border-white rounded-2xl p-6 h-full">
						...
						<div className="grid grid-cols-1 gap-4 mb-6">
							...
							<div className="parameter-group">
								...
								<div className="flex items-center space-x-2">
									...
									/>
									<div className="bg-amber-700 px-2 py-1 rounded text-amber-100 min-w-[2.5rem] text-center text-sm">
										{size}
									</div>
								</div>
